"""
Django settings for arches_project_v6 project.
"""
...
APP_NAME = 'arches_project_v6'
APP_ROOT = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))
STATICFILES_DIRS =  (os.path.join(APP_ROOT, 'media'),) + STATICFILES_DIRS

DATATYPE_LOCATIONS.append('arches_project_v6.datatypes')
FUNCTION_LOCATIONS.append('arches_project_v6.functions')
ETL_MODULE_LOCATIONS.append('arches_project_v6.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('arches_project_v6.search_components')
...
SECRET_KEY = 't(#sqnaz*h_5jeag%ujf8%&03wsbwvk%jkhbrjpvok^ac9-qux'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'arches_project_v6.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'arches_project_v6'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_project_v6.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'arches_project_v6.wsgi.application'
...
SESSION_COOKIE_NAME = 'arches_project_v6'
